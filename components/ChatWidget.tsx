  ...
  return (
    <>
      ...
      <button
        ...
        className={`fixed bottom-6 ${isRTL ? "left-6" : "right-6"} w-14 h-14 bg-blue-600 hover:bg-blue-700 text-white rounded-full shadow-lg flex items-center justify-center transition-transform hover:scale-105 z-40 no-print`}
      ...
      {isOpen && (
        <div className="fixed inset-0 z-50 no-print">
          ...
          {/* Panel */}
          <div
            className={`absolute top-0 ${isRTL ? "left-0" : "right-0"} h-full w-full sm:w-96 bg-white shadow-xl flex flex-col`}
          >
            {/* Header */}
